...
<template>
  <div class="min-h-screen flex items-center justify-center bg-background px-4">
    <div class="w-full max-w-2xl bg-white rounded-2xl shadow-lg p-8">
      <h1 class="text-3xl font-bold mb-2 text-primary text-center">
        Klacht indienen
      </h1>
      <p class="text-secondary text-center mb-8">
        Vul je gegevens in en voeg één of meer screenshots toe.
      </p>
      ...
      <div v-else class="text-center mt-8">
        <p class="text-2xl font-semibold text-primary mb-4">
          Bedankt, je klacht is verstuurd.
        </p>
        <p class="text-gray-600">
         We gaan er naar kijken maar dat kan even duren  </p>
      </div>
    </div>
  </div>
</template>
